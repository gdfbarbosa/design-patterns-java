package io.gdfbarbosa.patterns.behavioral.memento.editor;

import io.gdfbarbosa.patterns.behavioral.memento.commands.ColorCommand;
import io.gdfbarbosa.patterns.behavioral.memento.commands.MoveCommand;
import io.gdfbarbosa.patterns.behavioral.memento.shapes.Shape;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                io.gdfbarbosa.patterns.behavioral.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
